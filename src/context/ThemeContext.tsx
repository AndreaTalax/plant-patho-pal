...
const translations = {
  it: {
    ...
    plantHealthScanner: "Scanner Salute Piante",
    instantlyIdentify: "Identifica istantaneamente malattie delle piante e ottieni raccomandazioni di trattamento esperte",
    poweredByAI: "Basato su Tecnologia AI Avanzata",
    poweredBy: "Basato su",
    plantIdentification: "Identificazione Piante",
    forBestResults: "Per risultati ottimali, assicurati che la pianta sia ben illuminata e chiaramente visibile nell'inquadratura.",
    hideAIInfo: "Nascondi Info AI",
    showAIInfo: "Mostra Info AI",
    veryHighReliability: "Altissima Affidabilità",
    highReliability: "Alta Affidabilità",
    mediumReliability: "Media Affidabilità",
    lowReliability: "Bassa Affidabilità",
    howToTakePerfectPhoto: "Come scattare la foto perfetta",
    framePlantWell: "Inquadra bene la pianta",
    focusOnSymptoms: "Focalizza sui sintomi visibili",
    goodLighting: "Buona Illuminazione",
    goodLightingDesc: "Assicurati che la pianta sia ben illuminata, preferibilmente con luce naturale",
    clearFocus: "Messa a Fuoco Chiara",
    clearFocusDesc: "Mantieni la fotocamera stabile e metti a fuoco l'area interessata",
    showBackground: "Mostra lo Sfondo",
    showBackgroundDesc: "Posiziona la pianta in modo che il pavimento o lo sfondo sia visibile per un contesto migliore",
    multipleAngles: "Angolazioni Multiple",
    multipleAnglesDesc: "Scatta foto da diverse angolazioni per un'analisi migliore",
    tipsForBestResults: "Suggerimenti per Ottenere i Migliori Risultati",
    steadyHands: "Stabilità della foto",
    appropriateDistance: "Distanza appropriata",
    avoidBlurryPhotos: "Evita foto sfocate",
    avoidTooMuchZoom: "Evita troppo zoom",
    avoidBacklight: "Evita controluce",
    avoidObstacles: "Evita ostacoli",
    photoQualityTip: "La qualità della foto influisce direttamente sull'accuratezza della diagnosi AI.",
    yourActiveConversations: "Le tue conversazioni attive",
    noActiveConversations: "Nessuna conversazione attiva",
    clickToViewDetails: "Clicca su una conversazione per vedere i dettagli e continuare a chattare",
    unreadMessages: "Messaggi non letti",
    lastMessage: "Ultimo messaggio",
    deleteConversation: "Elimina conversazione",
    startNewDiagnosis: "Inizia una Nuova Diagnosi",
    toStartChatting: "Per iniziare a chattare con un esperto, devi prima effettuare una diagnosi.",
    performDiagnosis: "Effettua Diagnosi",
    ...
    remember: "Ricorda",
    aiDiagnosisRemainsFree: "La diagnosi AI rimane sempre gratuita! Puoi utilizzarla dalla sezione \"Diagnosi\".",
    conversationWithExpert: "Conversazione con Marco Nigro",
    conversationActive: "Attiva",
    startedOn: "Iniziata il",
    lastUpdate: "Ultimo aggiornamento",
    newProfessionalQuote: "Nuovo Preventivo Professionale",
    requestCustomQuote: "Richiedi un preventivo personalizzato per la tua azienda",
    toStartConversation: "Per iniziare una conversazione con il nostro esperto Marco Nigro, effettua prima una diagnosi dalla sezione \"Diagnosi\" e scegli la consulenza esperto.",
  },
  en: {
    appName: "Dr.Plant",
    ...
    instantlyIdentify: "Instantly identify plant diseases and get expert treatment recommendations",
    poweredByAI: "Powered by Advanced AI Technology",
    poweredBy: "Powered by",
    plantIdentification: "Plant Identification",
    forBestResults: "For best results, ensure your plant is well-lit and clearly visible in the frame.",
    hideAIInfo: "Hide AI Info",
    showAIInfo: "Show AI Info",
    veryHighReliability: "Very High Reliability",
    highReliability: "High Reliability",
    mediumReliability: "Medium Reliability",
    lowReliability: "Low Reliability",
    howToTakePerfectPhoto: "How to Take the Perfect Photo",
    framePlantWell: "Frame the plant well",
    focusOnSymptoms: "Focus on visible symptoms",
    goodLighting: "Good Lighting",
    goodLightingDesc: "Ensure your plant is well-lit, preferably with natural light",
    clearFocus: "Clear Focus",
    clearFocusDesc: "Keep the camera steady and focus on the affected area",
    showBackground: "Show Background",
    showBackgroundDesc: "Position the plant so the floor or background is visible for better context",
    multipleAngles: "Multiple Angles",
    multipleAnglesDesc: "Take photos from different angles for better analysis",
    tipsForBestResults: "Tips for Best Results",
    steadyHands: "Steady hands",
    appropriateDistance: "Appropriate distance",
    avoidBlurryPhotos: "Avoid blurry photos",
    avoidTooMuchZoom: "Avoid too much zoom",
    avoidBacklight: "Avoid backlighting",
    avoidObstacles: "Avoid obstacles",
    photoQualityTip: "The quality of the photo directly affects the accuracy of the AI diagnosis.",
    yourActiveConversations: "Your Active Conversations",
    noActiveConversations: "No active conversations",
    clickToViewDetails: "Click on a conversation to view details and continue chatting",
    unreadMessages: "Unread messages",
    lastMessage: "Last message",
    deleteConversation: "Delete conversation",
    startNewDiagnosis: "Start a New Diagnosis",
    toStartChatting: "To start chatting with an expert, you need to make a diagnosis first.",
    performDiagnosis: "Perform Diagnosis",
    ...
    remember: "Remember",
    aiDiagnosisRemainsFree: "AI diagnosis remains always free! You can use it from the \"Diagnose\" section.",
    conversationWithExpert: "Conversation with Marco Nigro",
    conversationActive: "Active",
    startedOn: "Started on",
    lastUpdate: "Last update",
    newProfessionalQuote: "New Professional Quote",
    requestCustomQuote: "Request a customized quote for your company",
    toStartConversation: "To start a conversation with our expert Marco Nigro, first perform a diagnosis from the \"Diagnose\" section and choose expert consultation.",
  }
};
